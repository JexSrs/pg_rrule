...
-- Simple tests
SELECT rrule_in('FREQ=WEEKLY;INTERVAL=1;UNTIL=20251231T235959Z;BYDAY=MO,WE,FR;BYHOUR=9;BYMINUTE=10;BYSECOND=2');
SELECT rrule_out(rrule_in('FREQ=WEEKLY;INTERVAL=1;UNTIL=20251231T235959Z;BYDAY=MO,WE,FR;BYHOUR=9;BYMINUTE=10;BYSECOND=2'));
